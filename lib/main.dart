...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      title: ChartTitle(text: 'Hi Daniel, \n here is your impact summary'),
  ...
  List<Nonprofits> getChartData() {
    final List<Nonprofits> chartData = [
      Nonprofits('Education', 50),
      Nonprofits('Environment', 5),
      Nonprofits('Health', 15),
      Nonprofits('Cultural', 25),
    ];
    return chartData;
  }
}
...
class Nonprofits {
  Nonprofits(this.org, this.impact);
  final String org;
  final int impact;
}
